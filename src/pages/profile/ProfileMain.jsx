      ...
      <div className="bg-white shadow-xl my-5 lg:my-10 rounded-xl md:rounded-2xl p-3 md:p-5">
        <div className="flex flex-col md:flex-row gap-5">
          ...
          <div className="md:w-8/12 lg:w-9/12">
            ...
            {activeComponent === "UserOrders" && <UserOrders />}
            {activeComponent === "UserFavorites" && <UserFavorites />}
            {activeComponent === "UserAddress" && <UserAddress />}
            {activeComponent === "UserChangeInfor" && <UserChangeInfor />}
          </div>
        </div>
      </div>
    </div>
